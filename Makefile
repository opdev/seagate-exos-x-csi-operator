...
VERSION ?= 0.0.6 # Also change the metadata.annotations.containerImage tag in config/manifests/bases/seagate-exos-x-csi-operator.clusterserviceversion.yaml
